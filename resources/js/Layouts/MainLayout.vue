<template>
    <div class="min-h-screen">
        <!-- Navigation Bar -->
        <nav class="fixed top-0 w-full z-50 bg-white bg-opacity-70 backdrop-blur-md shadow-sm">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    <div class="flex">
                        <div class="flex-shrink-0 flex items-center">
                            <span class="text-2xl font-bold text-blue-600">Palakasan</span>
                        </div>
                    ...
                    <div class="hidden sm:ml-6 sm:flex sm:items-center">
                        <button @click="$inertia.visit(route('login.show'))" class="bg-blue-600 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">Login</button>
                    </div>
