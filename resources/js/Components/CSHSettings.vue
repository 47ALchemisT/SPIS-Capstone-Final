            ...
            <div class="space-y-6">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <p class="mt-2 text-sm text-gray-900">{{ facilitator.student.first_name }} {{ facilitator.student.last_name }}</p>
                </div>

                <div>
                  <label class="block text-sm font-medium text-gray-700">Student ID</label>
                  <p class="mt-2 text-sm text-gray-900">{{ facilitator.student.id_number }}</p>
                </div>

                <div>
                  <label class="block text-sm font-medium text-gray-700">Email Address</label>
                  <p class="mt-2 text-sm text-gray-900">{{ facilitator.student.univ_email }}</p>
                </div>

                <div>
                  <label class="block text-sm font-medium text-gray-700">Course</label>
                  <p class="mt-2 text-sm text-gray-900">{{ facilitator.student.college }}</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="space-y-6">
              <div class="flex items-center justify-between">
                <div>
                  ...
                  <p class="mt-1 text-sm text-gray-600">Details about your committee head account.</p>
                </div>
                <div class="flex items-center">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p class="mt-2 text-sm text-gray-900">{{ formatDate(facilitator.created_at) }}</p>
                </div>

                <div>
                  <label class="block text-sm font-medium text-gray-700">Assigned College</label>
                  <p class="mt-2 text-sm text-gray-900">{{ assignedCollege ? assignedCollege.assigned_team.college.name : 'Not Assigned' }}</p>
                </div>
              </div>
                ...
                <div class="bg-blue-50 rounded-lg p-6">
                  <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-4 sm:space-y-0">
                    <div>
                      ...
                      <p class="text-sm text-blue-600">Manage your password and account security.</p>
                    </div>
                    <Link
