<template>
    ...
    <MainLayout :latestPalakasan="latestPalakasan">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="">
                <div class="p-6">
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-6">Palakasan History</h1>
                    ...
                    <div class="mb-6">
                        <div class="relative">
                            <input 
                                ...
                                class="w-72 pr-4 pl-8 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            >
                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            <thead class="bg-gray-50 dark:bg-gray-700">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Theme</th>
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Tagline</th>
                                ...
                                <tr v-for="palakasan in paginatedPalakasans" :key="palakasan.id" class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span :class="{
                                            ...
                                            'bg-green-100 text-green-800': palakasan.status === 'live',
                                            'bg-yellow-100 text-yellow-800': palakasan.status === 'upcoming',
                                            'bg-gray-100 text-gray-800': palakasan.status === 'completed'
                                        }">
                                            {{ palakasan.status }}
                                        </span>
                                    </td>
