    ...
    <AppLayout>
        <template v-slot:default>
            <div class="flex flex-col">
                <div class="p-2.5 bg-blue-50 text-blue-700 rounded-lg mb-4">
                    <p class="text-sm">
                        <i class="fa-solid fa-eye mr-2"></i>
                        <span class="font-semibold"><span class="font-medium">Viewing mood :</span> You are viewing the history of the sport.</span>
                    </p>
                </div>
