    ...
    <AppLayout>
        <template v-slot:default>
            <div class="space-y-2 px-2">
                <div class="flex items-center gap-6 bg-gradient-to-r from-blue-50 to-blue-100/50 rounded-2xl p-6 shadow-sm">
                    <div class="w-16 h-16 flex items-center justify-center bg-blue-100 rounded-xl shadow-sm">
                        <i class="fa-solid fa-hand text-4xl transform rotate-12 text-blue-700"></i>
                    </div>
                    <div class="flex-1">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="px-4 py-1.5 bg-blue-100 rounded-full text-sm font-medium text-blue-600 shadow-sm">
            ...
            <div class="grid grid-cols-1 px-2 gap-5 mt-6 sm:grid-cols-2 lg:grid-cols-4">
                        <!-- Statistics Cards -->
                        <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 ease-in-out transform hover:-translate-y-1">
                            <div class="p-6">
                                <div class="flex items-center justify-between mb-4">
                                    <h3 class="text-lg font-medium text-blue-700 tracking-tight">Colleges</h3>
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-blue-700 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                                    </svg>
                                </div>
                                <div class="flex items-baseline space-x-2">
                                    <span class="text-4xl font-semibold text-blue-700 tracking-tight">
                                    {{ colleges.length }}
                                    </span>
                                    <span class="text-sm font-medium text-blue-600 opacity-75">total</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 ease-in-out transform hover:-translate-y-1">
                            <div class="p-6">
                                <div class="flex items-center justify-between mb-4">
                                    <h3 class="text-lg font-medium text-blue-700 tracking-tight">Sports</h3>
                        ...
                        <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 ease-in-out transform hover:-translate-y-1">
                            <div class="p-6">
                                <div class="flex items-center justify-between mb-4">
                                    <h3 class="text-lg font-medium text-blue-700 tracking-tight">Venues</h3>
                        ...
                        <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 ease-in-out transform hover:-translate-y-1">
                            <div class="p-6">
                                <div class="flex items-center justify-between mb-4">
                                    <h3 class="text-lg font-medium text-blue-700 tracking-tight">Students</h3>
                ...
                <div class="">
                    <div class="">
                        ...
                        <div class="flex gap-4 mt-4">
                            ...
                            <Link href="/sport"  class="flex items-center bg-blue-50 py-2.5 px-4 rounded-lg hover:bg-blue-700  group transition-colors">
                            ...
                            <Link href="/college"  class="flex items-center bg-blue-50 py-2.5 px-4 rounded-lg hover:bg-blue-700  group transition-colors">
                                <div class="flex items-center gap-2 text-blue-600 group-hover:text-white transition-colors text-sm">
                                    <h3 class="font-medium">Add College</h3>
                                    <svg class="w-5 h-5" mlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><g class="plus-circle-outline"><g fill="currentColor" fill-rule="evenodd" class="Vector" clip-rule="evenodd"><path d="M12 17a1 1 0 0 1-1-1V8a1 1 0 1 1 2 0v8a1 1 0 0 1-1 1"/><path d="M17 12a1 1 0 0 1-1 1H8a1 1 0 1 1 0-2h8a1 1 0 0 1 1 1"/><path d="M22 12c0 5.523-4.477 10-10 10S2 17.523 2 12S6.477 2 12 2s10 4.477 10 10m-10 8a8 8 0 1 0 0-16a8 8 0 0 0 0 16"/></g></g></svg>
                                </div>
                            </Link>
                            <Link href="/points"  class="flex items-center bg-blue-50 py-2.5 px-4 rounded-lg hover:bg-blue-700  group transition-colors">
                                <div class="flex items-center gap-2 text-blue-600 group-hover:text-white transition-colors text-sm">
                            ...
                            <Link href="/venue"  class="flex items-center bg-blue-50 py-2.5 px-4 rounded-lg hover:bg-blue-700  group transition-colors">
                                <div class="flex items-center gap-2 text-blue-600 group-hover:text-white transition-colors text-sm">
                            ...
                            <Link href="/student"  class="flex items-center bg-blue-50 py-2.5 px-4 rounded-lg hover:bg-blue-700  group transition-colors">
                                <div class="flex items-center gap-2 text-blue-600 group-hover:text-white transition-colors text-sm">
                            ...
                            <Link href="/account"  class="flex items-center bg-blue-50 py-2.5 px-4 rounded-lg hover:bg-blue-700  group transition-colors">
                                <div class="flex items-center gap-2 text-blue-600 group-hover:text-white transition-colors text-sm">
                            ...
                            <Link href="/details"  class="flex items-center bg-blue-50 py-2.5 px-4 rounded-lg hover:bg-blue-700  group transition-colors">
                                <div class="flex items-center gap-2 text-blue-600 group-hover:text-white transition-colors text-sm">
                            ...
                            <div class=" h-full">
                                ...
                                <div class="flex items-center justify-between mb-6">
                                    ...
                                    <Link 
                                        ...
                                        class="inline-flex items-center px-3 py-1.5 text-xs font-medium text-blue-700 bg-blue-50 rounded-full hover:bg-blue-100 transition-colors duration-200"
                                    >
                                        View All
                                                ...
                                                <div class="relative flex items-start space-x-3">
                                                    ...
                                                    <div>
                                                        <div :class="[
                                                            'relative p-2',
                                                            {
                                                                'bg-green-100 ring-green-50': activity.type === 'create',
                                                                'bg-blue-100 ring-blue-50': activity.type === 'update',
                                                                'bg-red-100 ring-red-50': activity.type === 'delete'
                                                            }
                                                        ]" class="flex h-10 w-10 items-center justify-center rounded-full ring-8 ring-white shadow-sm">
                                                    ...
                                                    <!-- Activity Content -->
                                                    <div class="min-w-0 flex-1 bg-white rounded-lg  p-3">
                                                        <div>
                                                            <div class="text-sm">
                                                                <span class="font-medium text-gray-900">{{ activity.causer_name }}</span>
                                                                <span :class="{
                                                                    'text-green-600': activity.type === 'create',
                                                                    'text-blue-600': activity.type === 'update',
                                                                    'text-red-600': activity.type === 'delete'
...
const getStudentAssignedSports = (student) => {
    if (!props.assignedSports) return [];
    return props.assignedSports.filter(sport => 
        sport.assigned_players?.some(player => player.student_id === student.id)
    );
};
